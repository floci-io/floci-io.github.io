...
This lab is the hands-on companion to [Opening EC2 ports in-flight with socat](/chronicle/opening-ec2-ports-in-flight-with-socat/). The runnable version lives in [floci-labs](https://github.com/floci-io/floci-labs/tree/main/labs/ec2-open-ports-in-flight), where `./demo.sh` runs this whole flow end to end.
...
- Read the design story behind this lab: [Opening EC2 ports in-flight with socat](/chronicle/opening-ec2-ports-in-flight-with-socat/)
