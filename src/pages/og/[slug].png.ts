...
const pages = [
  ...
  { slug: 'aws',     title: 'floci',               sub: '59 AWS services. 24 ms startup. No auth token.',  color: '#FF9900', tag: 'Drop-in LocalStack replacement' },
  { slug: 'az',      title: 'floci-az',            sub: '17 Azure services. Native speed. MIT license.',   color: '#0078D4', tag: 'Blob · Queue · Functions · Key Vault · Cosmos DB' },
  { slug: 'gcp',     title: 'floci-gcp',           sub: '15 GCP services. No project, no billing.',         color: '#34A853', tag: 'Cloud Storage · Pub/Sub · Firestore · Secret Manager' },
